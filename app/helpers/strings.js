...
// restrictToStdDecimalNumber) into a fonero atom amount. This performs a
...
//
// Due to floating point inacuracies, a rounding function compatible to fnoutil
// `round` is used (see:
// https://github.com/fonero-project/fnod/blob/v1.1.2/fnoutil/amount.go#L77)
//
...
//
// This is fine for representing numbers within the range of the total fonero
// supply (up to 21e14) but may not be arbitrarily applicable.
export function strToFnoAtoms(s, unitDivisor) {
