...
import { cleanShutdown, GetFnodPID, GetFnowPID } from "./launch";
...
const darwinTemplate = (mainWindow, locale) => [
  {
    label: locale.messages["appMenu.fonero"],
    submenu: [ {
      label: locale.messages["appMenu.aboutFonero"],
      ...
      label: locale.messages["appMenu.hideFonero"],
