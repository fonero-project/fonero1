...
Options
  ...
  --extrawalletargs  Pass extra arguments to fnowallet
  --customBinPath    Custom path for fnod/fnowallet/fnoctl binaries
` : null;

export const DIFF_CONNECTION_ERROR = "daemon and fonero does not have the same network";
