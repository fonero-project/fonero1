...
export const EXTERNALREQUEST_FNODATA = "EXTERNALREQUEST_FNODATA";
...
export const allowExternalRequest = (externalReqType) => {
  ...
  case EXTERNALREQUEST_NETWORK_STATUS:
    addAllowedURL("https://testnet.fonero.org/api/status");
    addAllowedURL("https://mainnet.fonero.org/api/status");
    break;
  ...
  case EXTERNALREQUEST_POLITEIA:
    ...
    break;
  case EXTERNALREQUEST_FNODATA:
    addAllowedURL(FNODATA_URL_TESTNET);
    addAllowedURL(FNODATA_URL_MAINNET);
    break;
