...
const AccountsListHeader = ({ onGetNextAccountAttempt, isCreateAccountDisabled }) => <StandaloneHeader
  ...
  description={<T id="accounts.description" m={"Accounts allow you to keep separate records of your FNO funds.\nTransferring FNO across accounts will create a transaction on the blockchain."}/>}
