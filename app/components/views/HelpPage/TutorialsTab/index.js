...
export const TutorialsTabHeader = () =>
  <DescriptionHeader
    description={<T id="help.description.tutorials" m="Learn about the various aspects of the Fonero network." />}
  />;
  ...
  <Aux>
    ...
    <div className="overview-no-tickets">
      {/* <Link to="/mytickets/purchase" className="purchaseTickets">
        <T id="home.noTickets.purchase" m="Stake Your Idle FNO and Earn Rewards" /> →
      </Link> */}
