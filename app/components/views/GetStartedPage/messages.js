...
export const LoaderTitleMsg = () => <T id="loader.title" m={"Welcome to Fonero Wallet"}/>;
export const DiscoverAccountsInfoMsg = () =>
  ...
  Your account names aren't stored on the blockchain, so you will have to rename them after setting up Fonero.
  `}/>;
...
export const UpdateAvailableLink = ({ updateAvailable }) => (
  <Tooltip text={<T id="getStarted.updateAvailableTooltip" m="New version {version} available" values={{ version: (updateAvailable) }}/>}>
    <ExternalLink className="update-available-button" href="https://fonero.org/downloads">
...
export const AboutModalButton = ({ appVersion, updateAvailable }) => (
  <AboutModalButtonInvisible
    ...
    buttonLabel={<T id="help.about" m="About Fonero" />}
  />
);
