        ...
        {daemonWarning && getCurrentBlockCount <= 0 ?
          <Aux>
            <div className="get-started-last-log-lines">
              <div className="last-fnowallet-log-line">{daemonWarning}</div>
            </div>
            <div className="advanced-page-form">
              <div className="advanced-daemon-row">
                <T id="getStarted.longWaitWarning" m="You are currently upgrading to a new fnod version.  Typically, this one-time reindexing will take 30-45 minutes on an average machine."/>
              </div>
            </div>
          </Aux>:
          <div/>
