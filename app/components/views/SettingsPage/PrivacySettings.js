    ...
    <div className="settings-privacy">
      ...
      <div className="settings-column-content">
        <AllowableRequestType
          ...
          id="networking"
          description={<T id="settings.privacy.networkStatus.description" m="General network information (block height, etc) from fonero.org" />}
        ...
        <AllowableRequestType
          ...
          id="stakepool"
          description={<T id="settings.privacy.stakepoolListing.description" m="List of currently available stakepools from fonero.org" />}
        ...
        <AllowableRequestType
          ...
          id="politeia"
          description={<T id="settings.privacy.politeia.description" m="List and vote on proposals on proposals.fonero.org" />}
