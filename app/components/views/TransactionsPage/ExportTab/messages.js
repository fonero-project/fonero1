...
export default {
  ...
  dailyBalances: {
    ...
    fields: [
      ...
      { name: "totalStake", description: <T id="export.balances.fields.totalStake" m="Total amount of FNO used on staking." /> },
      ...
      { name: "voted", description: <T id="export.dailyBalances.fields.voted" m="Total amount, in FNO, of tickets voted" /> },
      { name: "revoked", description: <T id="export.dailyBalances.fields.revoked" m="Total amount, in FNO, of tickets revoked" /> },
      { name: "ticket", description: <T id="export.dailyBalances.fields.ticket" m="Total amount, in FNO, spent in tickets" /> },
    ]
  },
  balances: {
