...
class EyeFilterMenuWithSlider extends React.Component {
  ...
  componentDidMount() {
    ...
    if(maxFilterValue) {
      const maxValue = currencyDisplay === "FNO" ? maxFilterValue/unitDivisor : maxFilterValue;
    ...
    if(minFilterValue) {
      const minValue = currencyDisplay === "FNO" ? minFilterValue/unitDivisor : minFilterValue;
